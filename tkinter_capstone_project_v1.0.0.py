"""
This is a multi-window interface written in tkinter.The idea is to combine
several previous ideas to get off the tutorial trail and practice project design.
 It will feature a login page where you register or log in to an existing account,
a page to 'sample' the various options and choose one, and then you can use
whatever option you chose. As of now, I plan to have a up-to-date weather app and
